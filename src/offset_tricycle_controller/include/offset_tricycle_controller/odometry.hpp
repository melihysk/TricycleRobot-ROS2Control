...
#ifndef OFFSET_TRICYCLE_CONTROLLER__ODOMETRY_HPP_
#define OFFSET_TRICYCLE_CONTROLLER__ODOMETRY_HPP_
...
public:
  ...
  void setWheelParams(double wheelbase, double wheel_radius, double lateral_offset = 0.0);
...
#endif  // OFFSET_TRICYCLE_CONTROLLER__ODOMETRY_HPP_
