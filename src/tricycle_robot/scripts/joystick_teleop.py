    ...
    def publish_cmd(self):
        ...
        if abs(self.linear_vel) > 0.01:
            ...
            if abs(steering_angle) > 0.01:
                ...
                msg.twist.angular.z = self.linear_vel * math.tan(clamped_steering) / self.wheelbase
            else:
            ...
            if abs(self.steering_input) > 0.01:
                ...
                msg.twist.angular.z = self.steering_input * 2.0  # Arbitrary multiplier for responsiveness
            else:
                msg.twist.angular.z = 0.0
